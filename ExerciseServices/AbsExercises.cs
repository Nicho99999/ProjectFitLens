...
public class AbsExercises
{
    ...
    public List<AbsExercise> Exercises { get; set; } = new List<AbsExercise>();
    private HttpClient _httpClient;


    public AbsExercises(HttpClient httpClient)
    {
        _httpClient = httpClient;
    }

    public async Task FetchAbsExercises()
    {
        ...
        if (response.IsSuccessStatusCode)
        {
            ...
            Exercises = JsonConvert.DeserializeObject<List<AbsExercise>>(content);
