...
public class HamstringExercise
{
...
public class HamstringExercises
{
    public List<HamstringExercise> Exercises { get; set; } = new List<HamstringExercise>();
    
    private readonly HttpClient _httpClient;

    public HamstringExercises(HttpClient httpClient)
    {
        _httpClient = httpClient;
    }

    public async Task FetchHamstringExercises()
    {
        var muscle = "hamstrings";
        ...
        if (response.IsSuccessStatusCode)
        {
            ...
            Exercises = JsonConvert.DeserializeObject<List<HamstringExercise>>(result);
        }
        else
        {
