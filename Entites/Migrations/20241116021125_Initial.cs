    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AthleteNutritionInfos", x => x.NutritionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<int>(type: "int", maxLength: 10, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Athletes_AthleteNutritionInfos_NutritionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AthleteNutritionInfos_AthleteId",
                table: "AthleteNutritionInfos",
                column: "AthleteId");

            migrationBuilder.CreateIndex(
                name: "IX_Athletes_NutritionId",
                table: "Athletes",
                column: "NutritionId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AthleteNutritionInfos_Athletes_AthleteId",
                table: "AthleteNutritionInfos",
                column: "AthleteId",
